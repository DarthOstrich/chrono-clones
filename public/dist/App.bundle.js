...
var _episodeUpdate = __webpack_require__(10);

var _episodeUpdate2 = _interopRequireDefault(_episodeUpdate);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// listen for button clicks and fire updater if necessary
document.addEventListener("click", function (e) {
  var idChunk = e.target.id.split("-"),
      idPre = idChunk[0],
      idNum = idChunk[1],
...
function episodeUpdate(e) {
  ...
  _axios2.default.get('/api/v1/update?q=' + DBepID).then(function (res) {
    var parent = document.getElementById('episode-' + id);
